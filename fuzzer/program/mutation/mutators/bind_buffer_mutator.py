...
def bind_buffer_mutator_match(program, api, log_message, **kwargs):
    return log_message.message == "no buffer "


class BindBufferMutator(BaseMutator):
    def __init__(self):
        self.name = "BindBufferMutator"

    def _mutate(self, program, api, **kwargs):
        program.gen_args_for_api_and_add_to_program_by_name("bindBuffer")
        return True

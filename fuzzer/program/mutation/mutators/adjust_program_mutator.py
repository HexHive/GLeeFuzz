...
# _api_names="uniform2i"
_api_names = "*"


def adjust_program_mutator_match(program, api, log_message, **kwargs):
    return log_message.message == "location not for current program" or log_message.message == "location is not from current program"


class AdjustProgramMutator(BaseMutator):
    def __init__(self):
        self.name = "AdjustProgramMutator"

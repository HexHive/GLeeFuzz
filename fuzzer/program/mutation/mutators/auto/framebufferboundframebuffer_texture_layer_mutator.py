...
def framebufferboundframebuffer_texture_layer_mutator_match(
...
class FramebufferboundframebufferTextureLayerMutator(BaseMutator):
    def __init__(self):
        self.name = "FramebufferboundframebufferTextureLayerMutator"

    def _mutate(self, program, api, **kwargs):
        api.set_arg_val(1,
                        api.args[1].arg_type.gen_value(None, api, api.args[1]))
        print("FramebufferboundframebufferTextureLayer")
        return True

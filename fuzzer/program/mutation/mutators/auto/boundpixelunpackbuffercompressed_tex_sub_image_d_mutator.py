...
def boundpixelunpackbuffercompressed_tex_sub_image_d_mutator_match(
...
class BoundpixelunpackbuffercompressedTexSubImageDMutator(BaseMutator):
    def __init__(self):
        self.name = "BoundpixelunpackbuffercompressedTexSubImageDMutator"

    def _mutate(self, program, api, **kwargs):
        api.set_arg_val(1,
                        api.args[1].arg_type.gen_value(None, api, api.args[1]))
        print("BoundpixelunpackbuffercompressedTexSubImageD")
        return True

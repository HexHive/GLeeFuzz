...
def boundpixelunpackbuffercompressed_tex_image_d_mutator_match(
...
class BoundpixelunpackbuffercompressedTexImageDMutator(BaseMutator):
    def __init__(self):
        self.name = "BoundpixelunpackbuffercompressedTexImageDMutator"

    def _mutate(self, program, api, **kwargs):
        api.set_arg_val(1,
                        api.args[1].arg_type.gen_value(None, api, api.args[1]))
        print("BoundpixelunpackbuffercompressedTexImageD")
        return True

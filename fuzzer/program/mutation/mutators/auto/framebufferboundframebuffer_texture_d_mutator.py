...
def framebufferboundframebuffer_texture_d_mutator_match(
...
class FramebufferboundframebufferTextureDMutator(BaseMutator):
    def __init__(self):
        self.name = "FramebufferboundframebufferTextureDMutator"

    def _mutate(self, program, api, **kwargs):
        api.set_arg_val(1,
                        api.args[1].arg_type.gen_value(None, api, api.args[1]))
        print("FramebufferboundframebufferTextureD")
        return True

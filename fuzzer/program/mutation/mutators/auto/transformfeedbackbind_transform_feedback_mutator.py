...
_api_names = "bindTransformFeedback"


def transformfeedbackbind_transform_feedback_mutator_match(
...
class TransformfeedbackbindTransformFeedbackMutator(BaseMutator):
    def __init__(self):
        self.name = "TransformfeedbackbindTransformFeedbackMutator"

    def _mutate(self, program, api, **kwargs):
        program.gen_args_for_api_and_add_to_program_by_name(
            "createTransformFeedback")
        print("TransformfeedbackbindTransformFeedback")
        return True

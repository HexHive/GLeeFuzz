...
def transformfeedbackbegin_transform_feedback_mutator_match(
...
class TransformfeedbackbeginTransformFeedbackMutator(BaseMutator):
    def __init__(self):
        self.name = "TransformfeedbackbeginTransformFeedbackMutator"

    def _mutate(self, program, api, **kwargs):
        api.set_arg_val(0,
                        api.args[0].arg_type.gen_value(None, api, api.args[0]))
        print("TransformfeedbackbeginTransformFeedback")
        return True

...
def maskclear_mutator_match(program, api, log_message, **kwargs):
    return "mask" in (log_message.message.lower()
                      if log_message.message is not None else "")


class MaskclearMutator(BaseMutator):
    def __init__(self):
        self.name = "MaskclearMutator"
